...
//         const payload: UserPermission = {
//           permission: { id: uloga.id as number },
...
//       if (pronadjeni) {
//         this.UserPermissionService.delete(pronadjeni.id as number).subscribe({
//           next: () => {
...
//   private kreirajEntitetPremaUlogama(korisnik: UserPermissionList, uloga: string): void {
//     let entitet: UserPermissionList;
...
//   private ukloniEntitetPremaUlogama(korisnik: UserPermissionList, uloga: string): void {
//     let entitetId: number;

//     switch (uloga) {
//       case 'ROLE_STUDENT':
//         entitetId = korisnik.id as number;
