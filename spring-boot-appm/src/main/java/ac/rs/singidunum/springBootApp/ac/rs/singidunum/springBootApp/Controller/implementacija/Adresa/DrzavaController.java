...
import ac.rs.singidunum.springBootApp.ac.rs.singidunum.springBootApp.Service.implementacija.Adresa.DrzavaService;

@Controller
@RequestMapping("api/drzave")
public class DrzavaController extends GenericCrudController<DrzavaDTO, Drzava, Long> {
	@Autowired
	DrzavaService dService;

	@Override
	protected CrudService<DrzavaDTO, Drzava, Long> getService() {
