...
import ac.rs.singidunum.springBootApp.ac.rs.singidunum.springBootApp.Service.implementacija.Adresa.MestoService;

@Controller
@RequestMapping("api/mesta")
public class MestoController extends GenericCrudController<MestoDTO, Mesto, Long> {
	@Autowired
	private MestoService mestoService;

	@Override
	protected CrudService<MestoDTO, Mesto, Long> getService() {
