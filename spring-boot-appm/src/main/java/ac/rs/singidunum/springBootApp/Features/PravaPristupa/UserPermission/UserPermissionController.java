...
public class UserPermissionController extends GenericCrudController<UserPermissionDTORecord, UserPermission, Long> {
	@Autowired
	UserPermissionService oService;

	@Override
	protected CrudService<UserPermissionDTORecord, UserPermission, Long> getService() {
    ...
    @GetMapping("/lista")
    @ResponseBody
    public List<UserPermissionDTORecord> getKorisniciSaUlogama() {
