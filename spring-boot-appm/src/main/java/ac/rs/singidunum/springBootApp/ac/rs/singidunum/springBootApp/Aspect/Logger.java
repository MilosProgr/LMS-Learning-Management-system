package ac.rs.singidunum.springBootApp.ac.rs.singidunum.springBootApp.Aspect;
...
import ac.rs.singidunum.springBootApp.ac.rs.singidunum.springBootApp.Service.implementacija.Log.LogService;
...
public class Logger {
    ...
    @Before("@annotation(ac.rs.singidunum.springBootApp.ac.rs.singidunum.springBootApp.Aspect.Logged)")
    ...
    @AfterReturning(pointcut ="execution(* ac.rs.singidunum.springBootApp.ac.rs.singidunum.springBootApp.Service.*.*(..)) && args(id, ..)", returning="retVal")
