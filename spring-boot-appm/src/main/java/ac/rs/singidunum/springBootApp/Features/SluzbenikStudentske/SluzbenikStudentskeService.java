...
@Service
public class SluzbenikStudentskeService extends GenericCrudService<SluzbenikStudentskeDTORecord, SluzbenikStudentske, Long> {
	...
	protected SluzbenikStudentskeService(CrudRepository<SluzbenikStudentske, Long> repository,
			Mapper<SluzbenikStudentskeDTORecord, SluzbenikStudentske> mapper) {
		super(repository, mapper);
		this.sluzbenikStudentskeMapper = sluzbenikStudentskeMapper;
	}
	
	public SluzbenikStudentskeDTORecord promoteToSluzbenik(SluzbenikStudentske sluzbenik) {
